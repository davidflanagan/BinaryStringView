/*
 * BinaryStringView.js: a class that wraps an Array buffer
 * and implements String methods for it, providing a practical alternative
 * to the use of binary strings.
 *
 * Invoke the constructor on an ArrayBuffer, a Uint8Array, or a string.
 */
